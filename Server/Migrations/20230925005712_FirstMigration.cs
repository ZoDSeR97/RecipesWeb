    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HasIngredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HasIngredients_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HasIngredients_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HasIngredients_IngredientId",
                table: "HasIngredients",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_HasIngredients_RecipeId",
                table: "HasIngredients",
                column: "RecipeId");
